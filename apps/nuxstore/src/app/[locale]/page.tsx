...
export default async function HomePage() {
  ...
  const renderSection=(section:any,index:number)=>{
    ...
    if(section.type==='hero')return <div key={key} className="max-w-[1640px] mx-auto px-2 pt-2 md:px-4 md:pt-4"><div className="aspect-[4/5] min-h-0 overflow-hidden rounded-[10px] sm:aspect-[16/9] md:aspect-[2.67/1] md:min-h-[420px] md:rounded-[14px]"><HeroBanner locale={locale} banners={config.banners||[]} autoplaySeconds={speed||5}/></div></div>;
